...
const Features = () => {
  return (
    ...
    <motion.div
      ...
      className="w-full h-[100vh] flex pb-10"
    >
      ...
      >
        ...
        >
          {/* Sub-section with motion animation */}
          <motion.p variants={itemVariants} className="text-white font-mono">
      ...
      <motion.div variants={itemVariants} className="w-1/3 h-full relative">
        ...
        <div className="relative z-10 h-full w-full px-14">
          ...
          >
            {/* Sub-section with motion animation */}
            <motion.h2 variants={itemVariants} className="text-white text-5xl">
              On-Demand
            </motion.h2>
            <motion.p
              variants={itemVariants}
